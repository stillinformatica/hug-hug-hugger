...
serve(async (req) => {
  ...
  try {
    ...
    // Dados reais de teste baseados em um pedido real do sistema
    ...
    console.log("=== PAGBANK HOMOLOG REQUEST ===");
    ...
    console.log("=== PAGBANK HOMOLOG RESPONSE ===");
